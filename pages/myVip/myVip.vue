<template>
	<view>
		<image src="../../static/images/myVip-img.png" mode="widthFix" class="p-fX"></image>
		...
		<view class="mt-4">
			...
			<image src="../../static/images/myPost1.png" mode="widthFix"></image>
			<image src="../../static/images/myPost3.png" mode="widthFix"></image>
		</view>

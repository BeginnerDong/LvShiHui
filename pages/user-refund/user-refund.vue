	...
	<view>
		...
		<view class="p-3 p-r">
			...
			<view class="p-aXY p-4 m-3 colorf line-h">
				<view class="pb-3">
					<view class="o5">可提现</view><view class="price1">0.00</view>
				</view>
				<view class="flex1 pt-3">
					<view>
						<view class="o5">已提现</view><view class="price1">4000.00</view>
					</view>
					<view>
						<view class="o5">累计返钱(≈13.33吨)</view><view class="price1">4000.00</view>
					</view>
				</view>
		...
		<view class="line-h">
			...
			<view class="p-3 bB-e1" v-for="v in 4" :key='v'>
				<view class="font-32 font-w pb-3">买铝</view>
				<view class="flex1">
					<view>
						<view>1吨</view> <view class="font-24 color8 pt-2">数量</view>
					</view>
					<view>
						<view>+500</view> <view class="font-24 color8 pt-2">返钱</view>
					</view>
					<view class="text-right">
						<view>2020.07.11</view> <view class="font-24 color8 pt-2">入账时间</view>
					</view>
				</view>
			</view>
		</view>
		...
		<view class="px-3 pb-2 p-fX bottom-0 bT-e1 bg-white">
			...
			<view class="btnM" @click="Router.navigateTo({route:{path:'/pages/user-tixianApply/user-tixianApply'}})">申请提现</view>
		</view>
